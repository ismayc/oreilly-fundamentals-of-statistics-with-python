...
if "google.colab" in sys.modules:
    _DATA_BASE = "https://raw.githubusercontent.com/ismayc/oreilly-fundamentals-of-statistics-with-python/main/"
    for _fname in ["coffee_quality.csv", "data_dev_survey.csv"]:
...
If you aren't able to do this on your machine, you may want to check out [Google Colab](https://colab.research.google.com/github/ismayc/oreilly-fundamentals-of-statistics-with-python/blob/main/exercises_solutions.ipynb). It's a free service that allows you to run Jupyter notebooks in the cloud.
