---
title: "Walkthroughs and Exercises for *Fundamentals of Statistics in Python*"
...
print(data_dev_survey.isnull().sum())
...
print(data_dev_survey.describe())
```
...
```{python}
# Check for missing values
print(coffee_quality.isnull().sum())
...
print(data_dev_survey_imputed.head())
```
